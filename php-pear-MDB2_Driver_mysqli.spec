%define        _class           MDB2_Driver_mysqli
...
%doc
%{_datadir}/pear/MDB2/Driver/Datatype/mysqli.php
%{_datadir}/pear/MDB2/Driver/Function/mysqli.php
%{_datadir}/pear/MDB2/Driver/Manager/mysqli.php
%{_datadir}/pear/MDB2/Driver/Native/mysqli.php
%{_datadir}/pear/MDB2/Driver/Reverse/mysqli.php
%{_datadir}/pear/MDB2/Driver/mysqli.php
